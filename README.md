...
Spell-Explore runs a project of background agents against a locked goal, in fixed 138-minute rounds:
...
- Rounds are 138 minutes with binding per-phase windows; a phase that overruns is cut, and the round closes atomically with a decision list (abstracts of accepted routes; recycle / park for each unaccepted route; user nominations for next-round pairings).

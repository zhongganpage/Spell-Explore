...
[**Open interactive knowledge graph**](https://zhongganpage.github.io/Spell-Explore/) — a 254-node, 384-edge graph generated by [graphify](https://github.com/safishamsi/graphify) covering all agents, rules, templates, dossiers, and their relationships across 29 communities.

> The graph is also available locally as `graphify-out/graph.html`. To rebuild: `pipx install graphifyy && graphify .` then `graphify export html`.

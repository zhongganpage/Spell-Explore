...
workerB and workerC do not close after their review summaries — the Selector directs the Coordinator to hold them paused, with their panel context, across the PI rebuttal window, and to resume them for the vote at 118–138 / 119–139 / 127–149 (rounds 1–2 / round 3 / rounds ≥ 4); only then they close. workerD (the exterior reviewer) is not a held subagent: the Coordinator invokes it twice — the review and exchange (63–103 / 64–104 / 64–109) and the vote (118–138 / 119–139 / 127–149) with a consolidated prompt — and its context is reconstructed from files, never from a paused task (modules/providers.md). the promoter IS held: it runs 103–118 / 104–119 / 109–127 for the nearest true version note, is paused, then resumed (resume-by-ID, context preserved) at 118–138 / 119–139 / 127–149 for the connection marking (rules/selector.md §7.1), and closes only after the second duty.

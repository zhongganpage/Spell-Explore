...
workerB, workerC and workerD do not close after their review summaries — the Selector directs the Coordinator to hold them paused, with their panel context, across the PI rebuttal window, and to resume them for the vote at 118–138; only then they close.
